...
const Calculator = {
    ...
    Display_Value: '0',
    ///This will hold the operand for any expressions, we will set it for null for now///
    First_Operand: null,
...
///This modifies each time a button is clicked on///
...
function Input_Decimal(dot) {
    ///This ensures that accidental clicking of decimal point doesn't ///
...
function Handle_Operator(Next_Operator) {
    ...
    ///displayed on the screen to a # and then store the result ///
    ///in  Calculator.First_Operand if it doesn't already exist///
    const Value_of_Input = parseFloat(Display_Value);
    ///Checks if the operator already exists and if the Wait_Second_Operand is true///
