...
setTimeout(function () {   ///This function closes out the Recipe Modal windows after 10 secs of display///
...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        ...
        ///Variables to validate each field has been filled out///
        ...
        ///email address such as @ / . /and the text that would come before,
        ///between, and after.
