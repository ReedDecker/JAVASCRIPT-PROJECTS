...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        ///This calls a function to check if any win conditions///
        checkWinConditions();
    ...
    function computersTurn() {
        ///This boolean is need for a while loop///
        let success = false;
        ///This variable stores a random # 0-8///
        let pickASquare;
        ///This condition lets our while loop to keep trying if a square is selected already///
        while (!success) {
...
///for placement and sound('/.Media/place.mp3')///
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        ///This method checks if we've reached the endpoints///
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        ///This line clears our animation loop///
